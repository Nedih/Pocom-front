...
export default function Reactions(props){
    ...
    async function reactionHandler(event, type) {
    ...
    return(
        <div className='post_btns'>
            <span onClick={(e) => reactionHandler(e, 1)} hidden={post?.reactionStats && post?.reactionStats["Like"] > 0 ? false 
                : (true && reactionsHidden)} onMouseEnter={() => setReactionsHidden(false)} onMouseLeave={() => setReactionsHidden(true)}>
            ...
            <span onClick={(e) => reactionHandler(e, 2)} hidden={post?.reactionStats && post?.reactionStats["Fire"] > 0 ? false 
                : (true && reactionsHidden)} onMouseEnter={() => setReactionsHidden(false)} onMouseLeave={() => setReactionsHidden(true)}>
            ...
            <span onClick={(e) => reactionHandler(e, 3)} hidden={post?.reactionStats && post?.reactionStats["Dislike"] > 0 ? false 
                : (true && reactionsHidden)} onMouseEnter={() => setReactionsHidden(false)} onMouseLeave={() => setReactionsHidden(true)}>
            ...
            <div onMouseEnter={() => setReactionsHidden(false)} onMouseLeave={() => setReactionsHidden(true)} className="btnHoverContainer"></div>
        </div>    
    );
}